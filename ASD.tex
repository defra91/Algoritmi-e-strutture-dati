...
\includegraphics[width=100mm]{images/cover.png}
...
\include{algoritmi-golosi}
\include{huffman}
\include{analisi-ammortizzata}
\include{b-alberi}
\include{insiemi-disgiunti}
